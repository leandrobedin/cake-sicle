            ...
            <div className="text-center mb-12">
              <div className="mb-8">
                ...
                <div className="flex flex-col items-center justify-center">
                  ...
                  <div className="bg-frosting-dark text-white px-8 py-4 rounded-2xl">
                    <span className="text-lg">Por apenas</span>
                    <div className="text-4xl md:text-5xl font-bold">R$ 30,00</div>
              ...
              <a 
                ...
                className="inline-block bg-[#2E7D32] text-white text-xl font-bold px-10 py-5 rounded-full shadow-xl"
              >
